    ...
    for event in events:
        if event.name == "君に触れなくてよかった":
            ...
            stages.append(
                Stage(
                    event_id=event.id,
                    start_time=datetime(2025, 6, 1, 10),
            ...
            stages.append(
                Stage(
                    event_id=event.id,
                    start_time=datetime(2025, 6, 2, 4),
                    end_time=datetime(2025, 6, 2, 6),
                )
            )
            stages.append(
                Stage(
                    event_id=event.id,
                    start_time=datetime(2025, 6, 2, 8),
            ...
            stages.append(
                Stage(
                    event_id=event.id,
                    start_time=datetime(2025, 6, 3, 3),
                    end_time=datetime(2025, 6, 3, 5),
                )
            )
            stages.append(
                Stage(
                    event_id=event.id,
                    start_time=datetime(2025, 6, 3, 7),
                    end_time=datetime(2025, 6, 3, 9),
                )
            )
            ...
            stages.append(
                Stage(
                    event_id=event.id,
                    start_time=datetime(2025, 7, 3, 1),
                    end_time=datetime(2025, 7, 3, 3),
                )
            )
            stages.append(
                Stage(
                    event_id=event.id,
                    start_time=datetime(2025, 7, 3, 5),
                    end_time=datetime(2025, 7, 3, 7),
                )
            )
            stages.append(
                Stage(
                    event_id=event.id,
                    start_time=datetime(2025, 7, 3, 9),
                    end_time=datetime(2025, 7, 3, 11),
                )
            )
