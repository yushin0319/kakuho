...
describe('PaidStatusController', () => {
  ...
  it('受付ダイアログを表示する', () => {
    render(<PaidStatusController reservationId={1} onClose={onClose} />, {
      wrapper,
    });
  ...
  it('予約が見つからない場合に「予約が見つかりません」を表示する', () => {
    render(<PaidStatusController reservationId={999} onClose={onClose} />, {
      wrapper,
    });
  ...
  it('更新失敗時に onClose が呼ばれない', async () => {
    vi.mocked(updateReservation).mockRejectedValueOnce(
